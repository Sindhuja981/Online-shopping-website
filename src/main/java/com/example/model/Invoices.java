...
public class Invoices implements Serializable{
	...
	public Invoices(long invoiceNumber, long orderId, float invoiceAmount, String invoiceDate, String invoiceType,
	...
	public int addInvoices() {
		...
		try {
			...
			pst.setFloat(3, this.invoiceAmount);
	...
	public <invoices> List<Invoices> getAllInvoices() {
		...
		try {
			...
			while(rs.next()) {
				...
				invoices.setInvoiceAmount(rs.getFloat("invoiceAmount"));
				invoices.setInvoiceDate(rs.getString("invoiceDate"));
				invoices.setInvoiceType(rs.getString("invoiceType"));
